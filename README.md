...
- **게임의 핵심 경험**: [두 인격으로 단서를 찾고 해결하는 방식](#어떤-게임을-만들고-싶었는가)
- **스토리 진행 구조와 한계**: [Stage 상속과 코루틴](#스토리-진행을-어떻게-구현했는가)
- **인격 전환·Pulse 코드**: [퍼즐에 연결되는 방식](#인격-전환이-퍼즐에-연결되는-방식)
- **전체 구조와 공개 코드**: [인터랙티브 코드맵](https://sj97p.github.io/DualMind-CodeMap/)
...
|---|---|
| 장르 | 1인칭 내러티브 퍼즐 게임 |
| 개발 형태 | 기획 · 설계 · 구현 전반을 담당한 1인 개발 |
| 핵심 경험 | 인격 전환으로 단서를 찾고, 다른 인격으로 해결하는 퍼즐 |
| 주요 퍼즐 | 절차 생성 미로, Pulse 구 점등, 가짜 다리 판별, 인격 대결 |
| 엔딩 | Good / Normal / Bad Ending |
